...
|---|---|
| Persona 1 | Coordinación, Git, Docker, calidad, documentación y demo |
| Persona 2 | Kafka y MongoDB |
| Persona 3 | ETL, Redis y monitorización |
| Persona 4 | PostgreSQL, API y frontend |
