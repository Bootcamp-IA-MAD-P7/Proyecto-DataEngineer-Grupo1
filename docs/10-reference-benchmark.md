...
|---|---|
| Kafka acknowledgement can advance after a swallowed MongoDB failure | ADR-0005 and failure-path integration tests |
| Raw documents lack complete Kafka identity and unique index | Required envelope and compound index |
| Business classification accepts partial field overlap | Neutral observed variants until HRP-43/44 approve semantics |
