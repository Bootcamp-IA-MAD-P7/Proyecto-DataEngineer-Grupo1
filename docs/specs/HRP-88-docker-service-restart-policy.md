...
**Git evidence:** [f3a952b](https://github.com/Bootcamp-IA-MAD-P7/Proyecto-DataEngineer-Grupo1/commit/f3a952b) / [PR #79](https://github.com/Bootcamp-IA-MAD-P7/Proyecto-DataEngineer-Grupo1/pull/79) (2026-09-07).
**Closeout interpretation:** All six configured services use unless-stopped; this is not high availability or proof of fault recovery under load.
